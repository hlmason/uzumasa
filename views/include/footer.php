	...
	<script src="<?php echo BASE_URL; ?>assets/javascripts/imagesloaded.min.js"></script><!-- Preloads background image and resizes each 'slide' to be 100% of the browser viewport (for parallax scrolling) / Needs to be above skrollr.min.js and _main.js to work -->
